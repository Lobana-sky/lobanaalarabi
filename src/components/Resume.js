                      ...
                      <div className="row" style={{margin:"1em"}}>
                        ...
                        <div className="col-md-4">
                          <div className="cardR cardR-2">
                            ...
                            {/* <span className="colorChange">Female | 9/march/1990 | syrian</span> */}
                            <p className="colorChange">Good command of Microsoft Visual studio, Sql server 2008, Matlab.
                      ...
                      <div className="row" style={{margin:"1em"}}>
                        <div className="col-md-4">
                          <div className="cardR cardR-1">
                            ...
                            <p className="colorChange">AT Mathematical Statistics Department <a href="https://alepuniv.edu.sy/view-faculty/college-of-science">College of Science</a> I taught several subjects for
                        ...
                        <div className="col-md-4">
                          <div className="cardR cardR-1">
                            ...
                            <p className="colorChange">Worked as a trainer in <a href="http://www.itc-center.com/">ITC</a> for two courses 
                      ...
                      <div className="row" style={{margin:"1em"}}>
                        <div className="col-md-4">
                          <div className="cardR cardR-6">
                            ...
                            <p className="colorChange"> B.A. Informatics engineering at the <a href="https://alepuniv.edu.sy/view-faculty/faculty-of-informatics-engineering">Aleppo University</a> with
                        ...
                        <div className="col-md-4">
                          <div className="cardR cardR-5">
                            ...
                            <p className="colorChange">Arabic native - English Advanced - Turkish intermediate</p>
                          </div>
                        </div>
                        {/* <div className="col-md-4">
                          <div className="cardR cardR-3">
